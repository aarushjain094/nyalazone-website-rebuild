  ...
  return (
    <div className="hero-orbit-column" aria-hidden="true">
      <div className="hero-orbit-wrap">
        <svg className="orbit-rings-svg" viewBox="0 0 270 270" fill="none">
          <circle cx="135" cy="135" r="70" stroke="#c0c0c0" strokeWidth="1.5" strokeDasharray="5 5"/>
          <circle cx="135" cy="135" r="110" stroke="#c0c0c0" strokeWidth="1.5" strokeDasharray="5 5"/>
        </svg>
