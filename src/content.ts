...
export const partnersPage: TextPage = {
  title: "Partners",
  paragraphs: [
    "Building Strategic Alliances for Digital Transformation",
    "At Nyalazone, we build strong strategic alliances with technology providers, consulting firms, and service companies to unlock new value streams and deliver integrated digital transformation outcomes across enterprise and government sectors.",
    "Our partner ecosystem empowers organizations to extend capabilities through co-delivery, license resale, and collaborative innovation — creating measurable impact at scale.",
  ],
  bullets: [
    "Technology resale and co-delivery of Nyalazone's AI-enabled platforms",
    "Access to preferential licensing rates, training, and sales support",
    "Joint solution development for enterprise and government programs",
    "Co-branding opportunities and collaborative go-to-market strategies",
    "Professional certifications across Leggero DMAP, DDS, and DCE platforms",
    "Contact the partnerships team: partners@nyalazone.com",
  ],
  imageUrl: "https://nyalazone.ai/wp-content/uploads/2025/04/LP_AI_enabled.png",
...
export const partnerProgramPage: TextPage = {
  ...
  paragraphs: [
    "Empowering Partners to Deliver Digital Transformation",
    "Nyalazone's Partner Program empowers technology providers, consultants, and service companies to unlock new revenue streams by reselling Nyalazone.ai licenses and delivering value-added services.",
    "Partners receive preferential licensing rates, training, sales support, and marketing assistance — alongside opportunities for service expansion including implementation, customization, and consulting.",
    "Products available for license resale and service delivery:",
  ],
  bullets: [
...
export const certificationsPage: TextPage = {
  ...
  paragraphs: [
    "At Nyalazone, we believe that real transformation starts with trusted expertise. Our team consists of certified professionals with globally recognized credentials in project management, digital service design, data science and AI, cloud architecture, and enterprise delivery governance.",
  ],
  bullets: [
    "Project Management Professional (PMP)",
    "Australian Government Digital Transformation Agency (DTA) certified consultants",
    "Data Science and AI Certified Specialists",
    "Pega Certified Professionals",
  ],
  imageUrl: "https://nyalazone.ai/wp-content/uploads/2025/04/LP_data_analytics.png",
};

export const aboutPage: TextPage = {
  title: "About Nyalazone",
  headerLogoUrl: "https://nyalazone.ai/wp-content/uploads/2025/04/NZ_AI_Col.png",
  paragraphs: [
...
export const globalTeamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    imageUrl: "https://nyalazone.ai/wp-content/uploads/2025/04/About_Team_3_2-scaled-r3utgaftkaf9ph7h53yr9nbsq3t8r3shi9lliutzww.jpg",
    paragraphs: [
...
export const careersPage: TextPage = {
  ...
  paragraphs: [
    ...
    "Whether you're just getting started or already have some industry XP, we care more about how you think than what's on your résumé.",
...
export const resourcesIntro =
  "Discover our latest insights and thought leadership on AI, data management, and digital transformation.";

export const resources: CardItem[] = [
  {
    title: "NLP Model Prompt Engineering in Healthcare",
    to: "/resources",
    description:
      "Advancements in Natural Language Processing and Large Language Models have transformed healthcare, improving diagnostics and decision support through prompt engineering.",
  },
  {
    title: "NLP-Powered Triage and Multi-Document Classifier",
    to: "/resources",
    description:
      "Explore how AI triage and document classification improve efficiency, consistency, and data interpretation in enterprise and public sector workflows.",
  },
  {
    title: "Data and AI strategy: Why your project failed",
    to: "/resources",
    description:
      "Learn common causes of AI initiative failure and practical approaches to building resilient, outcome-driven data and AI strategies.",
  },
];
...
export const detailPages: Record<string, TextPage> = {
  "/leggero-ai": {
    ...
    imageUrl: "https://nyalazone.ai/wp-content/uploads/2026/02/Leggeri.ai_.png",
    boldFirstParagraph: true,
  },
  "/leggero-data-management-analytics-platform": {
    ...
    imageUrl: "https://nyalazone.ai/wp-content/uploads/2026/01/Group-13.png",
    boldFirstParagraph: true,
  },
  "/leggero-dynamic-data-source": {
    ...
    imageUrl: "https://nyalazone.ai/wp-content/uploads/2026/01/Group-12.png",
    boldFirstParagraph: true,
  },
  "/digital-customer-engagement-platform": {
    ...
    imageUrl: "https://nyalazone.ai/wp-content/uploads/2026/01/Group-11.png",
    boldFirstParagraph: true,
  },
  "/advanced-data-integration-platforms": {
    ...
    paragraphs: [
      ...
      "Layered with DDS, Leggero brings advanced capabilities in data storage, semantic enrichment, governance, and analytics. It enables the centralized management of structured data, supports large-scale distributed processing, and transforms raw datasets into actionable intelligence through interactive dashboards, advanced visualizations, and AI-powered modeling tools. The platform also offers metadata and lifecycle management-ensuring trust, traceability, and control over enterprise data assets.",
      "Together, DDS and Leggero form a comprehensive, future-ready Data Integration Platform that adapts to your organization's evolving data ecosystem. Whether it's enabling intelligent data exchange, powering AI/ML workflows, or streamlining business analytics, this integrated stack delivers the performance, intelligence, and flexibility required to turn complex data into strategic advantage.",
    ],
    boldFirstParagraph: true,
  },
  ...
  "/complex-data-migration": {
    ...
    paragraphs: [
      ...
      "Taking it further, DDS is enhanced with AI-enabled transformation capabilities. Leveraging Gen-AI and LLMs, the platform can intelligently extract structured data from unstructured sources, recommend transformation logic, and generate derived attributes on the fly. This reduces manual effort, improves accuracy, and enables semantic understanding of data-critical in preparing high-quality, AI-ready datasets during migrations.",
  ...
  "/gen-ai-enabled-process-automation": {
    ...
    paragraphs: [
      ...
      "Layered on top is DCE, our enterprise-grade engagement platform that connects stakeholders-customers, employees, and partners-through intelligent workflows and omni-channel communication. DCE uses AI to orchestrate task instances, automate service ticketing, lead management, and notification flows, and streamline multi-party collaboration through Workspaces and Workgroups.",
      "With Gen-AI integrated, it enhances interactions through natural language understanding, AI-generated responses, intelligent knowledge recommendations, and predictive engagement flows. DCE also powers advanced use cases like QA process automation, invoice and PO verification, and document validation and prediction, reducing manual effort and improving accuracy across critical business processes-transforming routine tasks into proactive, self-evolving operations.",
      "Together, DDS and DCE enable organizations to move beyond rule-based automation into a world of adaptive, AI-driven process automation. From intelligent data ingestion to conversational engagement, from predictive notifications to contextual knowledge delivery-our platforms automate not just actions, but decisions. The result is a digital enterprise that operates faster, learns continuously, and delivers personalized, efficient service at scale.",
    ],
    boldFirstParagraph: true,
  },
  ...
  "/operations-management-using-activity-orchestration": {
    ...
    paragraphs: [
      ...
      "At the core of DCE is a robust task management engine that enables organizations to define, assign, and monitor tasks across teams and departments with precision. Whether it's a multi-step approval, service resolution, or partner onboarding process, DCE structures workflows into task groups and task instances-clearly delineating responsibilities, dependencies, and SLAs at every stage.",
      "The engine also supports system tasks that can be automatically triggered within workflows-reducing manual intervention and accelerating execution. These automated actions help streamline repetitive steps, enforce business logic, and maintain process integrity without constant user input. Combined with AI-enabled orchestration, DCE can intelligently route tasks, surface insights, and optimize performance across operations.",
      "Each activity is tracked end-to-end, with built-in escalation rules, real-time status updates, and performance metrics to ensure nothing falls through the cracks. With DCE at the helm, organizations gain a centralized command center for operations-eliminating ambiguity, enforcing accountability, and driving consistent execution. From back-office coordination to customer-facing processes, DCE transforms operations into a well-orchestrated, transparent, and outcome-driven engine.",
    ],
    boldFirstParagraph: true,
  },
};
